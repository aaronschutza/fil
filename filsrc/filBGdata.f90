...
subroutine readAM03
	...
	do i = 1,gridi
	 do j = 1,gridj
		write(11,*) i,j,xg(i),zg(j),Bxg(i,j),Bzg(i,j),Bxg_d(i,j,1),Bzg_d(i,j,1),Bxg_d(i,j,2),Bzg_d(i,j,2),Bxg_d(i,j,3),Bzg_d(i,j,3)
	 enddo
	enddo
	close(11)
...
subroutine readTsyFric
	...
	integer :: ogi,ogj,ogk,yslice
	real :: tslice
	real :: dipx,dipy,dipz,Bx,Bz,pgxmax,pModelWang2013,pgxmin
	logical :: useGaussSmoother = .true.
...
subroutine makeTsyData
	...
	implicit none
	integer :: i,j,k,l
	real :: c0,c1,c2,c3,c4,c5,dxBz,dzBx,Bx,Bz,pModelWang2013
	real :: dipx,dipy,dipz
	logical :: openPoint
