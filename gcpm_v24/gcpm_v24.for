...
c  acceptable L-shell value, without causing problems.
	...
	al=r/clat
	aheight=(r-1.0)*re
d	  type *,'setup:',r,alatr,al,aheight,tranlow,tranhigh,altrans,alcrit
