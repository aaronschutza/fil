...
c        COVSAT=63.75+rlimit*(0.728+rlimit*0.00089)
        ...
        if(jf(25)) then
        	f107d=cov
        	call APF_ONLY(iyear,month,iday,F107DX)
...
104         FORMAT('iri2007/ccir',I2,'.asc')
...
1144          FORMAT('iri2007/ursi',I2,'.asc')
c-web- special for web-version:
c 1144  FORMAT('/usr/local/etc/httpd/cgi-bin/models/IRI/ursi',I2,'.asc')
c-binary- if binary files than use:
